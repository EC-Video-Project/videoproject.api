...
/* harmony import */ var _middleware_midWrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../middleware/midWrapper */ "../../../src/middleware/midWrapper.ts");
...
const rawHandler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let resBody;
    const dynamo = new aws_sdk__WEBPACK_IMPORTED_MODULE_0__.DynamoDB.DocumentClient({ region: 'us-west-2' }); // DocumentClient uses json formatting
    try {
        resBody = yield dynamo.scan(params).promise();
    }
    catch (err) {
        resBody = err;
        console.log(err);
...
const handler = (0,_middleware_midWrapper__WEBPACK_IMPORTED_MODULE_1__["default"])(rawHandler);
